...
public class EntityAction extends play.mvc.Action.Simple {
    private final Logger logger = LoggerFactory.getLogger("application.EntityAction");
    ...
    @Singleton
    @Inject
    public EntityAction(MetricRegistry metrics, ClassLoaderExecutionContext ec, Futures futures) {
        this.ec = ec;
        this.futures = futures;
        this.requestsMeter = metrics.meter("requestsMeter");
        this.responsesTimer = metrics.timer(name(EntityAction.class, "responsesTimer"));
    }
